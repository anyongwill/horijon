    ...
    <section id="manifesto" className="manifesto">
      <div className="manifesto__content">
        ...
        <div className="manifesto__body1">
          <h3>Art has always been a profound dialogue of humanity, transcending ownership and time, yet its essence faces a seismic shift in the era of Generative AI. Once steeped in personal expression and communal resonance, art is now at risk of commodification, with originality and craftsmanship threatened by algorithmic outputs. Generative AI, a powerful tool capable of surpassing human memory and experience, challenges the very core of creative autonomy, reducing artists to mere data providers and risking a loss of artistic diversity. This transformation mirrors historical shifts, from the printing press to photography, but with unprecedented implications: the erosion of authenticity, diminished creative struggle, and the looming stagnation of progress. We believe artists must wake up to this challenge, unite across disciplines to reclaim their role as society's visionaries.</h3>        
